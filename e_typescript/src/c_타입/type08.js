//! 타입 단언 (Type Assertion) as 키워드 사용법
//? 타입 단언이란 개발자가 특정 값의 타입을 직접 지정하는 방법
...
// someValue = true; // 어떤 값이든 할당 가능하지만! 개발자가 문자열로 단언!하고 싶음
// let length = someValue.length;
// console.log(length);    // undefined
var length = someValue.length;
console.log(length); // 16
// * 처음에는 any 타입이었던 someValue 변수가
// * as string 타입 단언을 통해 문자열로 간주되어
// * length 프로퍼티에 접근 가능해짐
//? 타입 단언 사용 예시
