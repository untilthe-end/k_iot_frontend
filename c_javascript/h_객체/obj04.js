// # 자바스크립트 객체의 '프로토타입'
// : 객체의 원형(프로토타입)을 사용하여 새로운 객체를 생성 - 견본 | 시제품
// > 객체의 속성과 메서드 재사용 가능
...
class UpperCamelCaseName {
  ...
  // 생성자: 클래스 명과 동일하지 않고 모든 생성자 메서드명은 constructor 이다!!
...
let person = new Person('시훈', '이');
console.log(person.name); // { first: '시훈', last: '이' } 객체 자체여서 